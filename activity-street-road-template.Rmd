...
```
- After grouping the data by their street endings, counting up the totals and sorting in descending order, it is easy to see that "ST" is the most commonly used in this dataset, with over 906 cases. The Second and third highest were "DR" at 781 and "RD" at 756. Overall, it seems the abbreviated names ("RD" vs "ROAD") tend to be more commonly used.
